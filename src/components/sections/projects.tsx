...
const projectsData = [
  {
    ...
    tech: ['TypeScript', 'Node.js', 'PostgreSQL', 'Message Queues', 'WebSockets'],
    color: 'cyan',
    hasDemo: true,
  ...
  },
  {
    ...
    impact: ['60% memory footprint reduction', '50K+ messages/sec handled', '60fps maintained'],
    tech: ['React', 'TypeScript', 'IndexedDB', 'WebSockets', 'Real-time Charts'],
    color: 'blue',
    hasDemo: true,
  ...
  },
  {
    ...
    impact: ['70% faster CRUD development', 'Model-driven generation', 'Web + mobile output'],
  ...
  },
  {
    ...
    impact: ['40% faster time-to-market', '50K+ users served', '4.6★ app store rating'],
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <p className="text-muted-foreground text-base sm:text-lg max-w-2xl">
            Production systems I&apos;ve architected and shipped—real solutions to complex
            ...
            <motion.div key={project.id} variants={cardVariants}>
              ...
              >
                ...
                <CardContent>
                  ...
                  <div className="mb-4">
                    <h4 className="text-sm font-semibold mb-2 text-foreground">Challenge</h4>
                    <p className="text-sm text-muted-foreground">{project.challenge}</p>
                  </div>

                  <div className="mb-4">
                    <h4 className="text-sm font-semibold mb-2 text-foreground">Impact</h4>
                  ...
                  <div className="flex items-center gap-4">
                    {project.hasDemo && (
                      <Dialog
                        open={openDemo === project.id}
                        onOpenChange={(open) => setOpenDemo(open ? project.id : null)}
                      >
