      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl">
            I design and ship production systems across web, mobile, and
            desktop. From complex frontend state management to APIs, data
            modeling, and real-time pipelines—I handle the full stack.
          </p>
        </motion.div>

        <div className="relative">
          <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-cyan-500/50 via-cyan-500/20 to-transparent" />
                  ...
                  <Card className="bg-card/50 border-border hover:border-primary/50 transition-colors">
                    <CardHeader>
                      <div className="flex flex-col md:items-end gap-2">
                        <Badge
                          variant="outline"
                          className="border-cyan-500/50 text-cyan-400 w-fit"
                        >
                          {item.year}
                        </Badge>
